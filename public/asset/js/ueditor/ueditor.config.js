...
(function () {
	...
	//统一入口地址
	var IMGUPLOADURL = 'http://img.dazemall.com/uploadimg.php?type=ueditor';

	//本地入口地址
	//var IMGUPLOADURL = URL + "php/imageUp.php";
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,snapscreenServerUrl: IMGUPLOADURL //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/php/snapImgUp.php"”
        //,snapscreenPath: URL + "php/"
        ,snapscreenServerPort: location.port                                   //屏幕截图的server端端口
        //,snapscreenImgAlign: ''                                //截图的图片默认的排版方式

        //word转存配置区
        ,wordImageUrl:IMGUPLOADURL             //word转存提交地址
