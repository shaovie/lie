...
<body class="no-skin">
	...
	<form action="/admin/Oss/search" class="form-horizontal" method="get">
	<table class="table table-striped table-bordered table-hover">
	<tbody>
		<tr>
			<td>
				<li style="float:left;list-style-type:none;">
					<span style="margin-right:10px;">Bucket名称</span>
                    <input style="margin-right:10px;margin-top:10px;width:160px; height:34px; line-height:28px; padding:2px 5px"
                    name="searchName" id="searchName" type="text"
                    value="<?php if (!empty($search['searchName'])) {echo $search['searchName'];} ?>" placeholder="模糊匹配">
				</li>
				<li style="float:left;list-style-type:none;">
	...
	<table class="table table-striped table-bordered table-hover">
		<tbody>
		<tr>
			<th class="text-center" style="width:150px;">Bucket名称</th>
			<th class="text-center" style="width:300px;">外网域名</th>
		...
		<tr>
			...
			<td style="text-align:center;vertical-align:middle;">
                <a class="btn btn-xs btn-info" href="/admin/Oss/del?name=<?php echo $one['name'];?>" onclick="return confirm(&#39;确认删除吗？&#39;);return false;">删除</a>
			</td>
		</tr>
        <?php endforeach?>
		</tbody>
