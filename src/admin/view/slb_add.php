...
<body class="no-skin">
	...
	<form action="<?php echo $action?>" method="post" enctype="multipart/form-data" class="form-horizontal" role="form" id="save-form">
		<div class="form-group">
			<label class="col-sm-2 control-label no-padding-left">区域编号：</label>
			<div class="col-sm-9">
				<input type="text" name="regionId" id="regionId" maxlength="100" class="span7">
                <span class="help-inline">从‘区域列表’中选取</span>
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label no-padding-left">实例名：</label>
			<div class="col-sm-9">
				<input type="text" name="slbName" id="slbName" maxlength="100" class="span7">
                <span class="help-inline">（选填）长度限制为1-80个字符，允许包含字母、数字、‘-’、‘/’、‘.’、‘_’。默认为系统随机分配</span>
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label no-padding-left"></label>
			<div class="col-sm-9">
				<button type="button" id="save-btn" class="btn btn-primary span2" >提交</button>
                <span class="help-inline">默认按使用流量计费</span>
			</div>
		</div>
