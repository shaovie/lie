	...
	<form action="<?php echo $action?>" method="post" enctype="multipart/form-data" class="form-horizontal" role="form" id="save-form">
		<div class="form-group">
			...
			<div class="col-sm-9">
                ...
                <span class="help-block">以英文逗号(,)分隔</span>
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label no-padding-left">主机记录RR：</label>
			<div class="col-sm-9">
				<input type="text" name="rr" id="rr" maxlength="100" class="span7">
                <span class="help-inline">不填即默认为 @ ，支付[a-z]表达式</span>
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label no-padding-left">绑定IP：</label>
			<div class="col-sm-9">
				<input type="text" name="value" id="value" maxlength="100" class="span7">
			</div>
		</div>
		<div class="form-group">
