...
<body class="no-skin">
	<h3 class="header smaller lighter blue"><span style="margin-right:20px"><?php echo $title;?></span><a href="/admin/Activity/addGoodsPage?actId=<?php echo $actId?>" class="btn btn-primary">添加商品</a><span class="refresh">刷新</span></h3>
	...
	<table class="table table-striped table-bordered table-hover">
		...
		<tr>
			...
			<td style="text-align:center;vertical-align:middle;">
                <a class="btn btn-xs btn-info" href="/admin/Activity/editGoodsPage?actId=<?php echo $actId;?>&goodsId=<?php echo $goods['goods_id']?>">编辑</a>
                <a class="btn btn-xs btn-info" href="/admin/Activity/delGoods?actId=<?php echo $actId;?>&goodsId=<?php echo $goods['goods_id']?>" onclick="return confirm(&#39;确认删除吗？&#39;);return false;">删除</a>
			</td>
		</tr>
        <?php endforeach?>
		</tbody>
